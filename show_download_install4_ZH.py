...
class MyDialog(wx.Dialog):
    def __init__(self, parent, id, title):
        wx.Dialog.__init__(self, parent, id, title, pos=(500,150),size=(600, 450),style=wx.DEFAULT_DIALOG_STYLE)
        ...
        grid_button= wx.GridSizer(2,6,5,5)
        ...
        grid_button.AddMany([
                       (wx.Button(panl, 10, '刷新列表'.decode('utf8'),size=(80,40)), 0,wx.ALIGN_CENTER),
                       (wx.Button(panl, 11, '清空列表'.decode('utf8'),size=(80,40)), 0,wx.ALIGN_CENTER),
                       (wx.Button(panl, 12, '下载最新'.decode('utf8'),size=(80,40)), 0,wx.ALIGN_CENTER),
                       (wx.Button(panl, 13, '移除本地'.decode('utf8'),size=(80,40)), 0,wx.ALIGN_CENTER),
                       (wx.Button(panl, 14, '截取屏幕'.decode('utf8'),size=(80,40)), 0,wx.ALIGN_CENTER),
                       (wx.Button(panl, 15, '重启设备'.decode('utf8'),size=(80,40)), 0,wx.ALIGN_CENTER),
                       (wx.Button(panl, 16, '单个安装'.decode('utf8'),size=(80,40)), 0,wx.ALIGN_CENTER),
                       (wx.Button(panl, 17, '全部安装'.decode('utf8'),size=(80,40)), 0,wx.ALIGN_CENTER),
                       (wx.Button(panl, 18, '覆盖安装'.decode('utf8'),size=(80,40)), 0,wx.ALIGN_CENTER),
                       (wx.Button(panl, 19, '清除数据'.decode('utf8'),size=(80,40)), 0,wx.ALIGN_CENTER),
                       (wx.Button(panl, 20, '发送数据'.decode('utf8'),size=(80,40)), 0,wx.ALIGN_CENTER),
                       (wx.Button(panl, 21, '关闭窗口'.decode('utf8'),size=(80,40)), 0,wx.ALIGN_CENTER)])
        ...
        # self.Bind(wx.EVT_BUTTON, lambda event,param=11:self.event_ctrl.OnClear(event,param), id=12)
